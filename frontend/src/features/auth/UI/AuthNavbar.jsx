...
const AuthNavbar = ({ onOpenApp }) => {
  return (
    <header className="auth-navbar" role="banner">
      <div className="auth-brand" title="chatSocial">
